# rb101_109 / small_problems / medium_1 / exercise_8.rb

####### Fibonacci Numbers (Recursion) #######

# The Fibonacci series is a sequence of numbers starting with 1 and 1 where each number is the
# sum of the two previous numbers: the 3rd Fibonacci number is 1 + 1 = 2, the 4th is 1 + 2 = 3,
